        ...
        <div class="create-form">
            ...
            <form action="{{ route('superadmin.users.update', $user->id) }}" method="POST">
                ...
                <div class="mb-4" id="categoryWrapper"
                    ...
                    <input type="text" id="newCategoryInput" class="form-control mt-2" placeholder="New category name"
                        style="display:none;">
                    <button type="button" class="btn btn-success mt-2" id="saveNewCategory" style="display:none;">Add
                        Category</button>
                </div>
