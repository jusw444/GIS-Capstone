...
<div class="container">
    ...
    <form action="{{ route('classifications.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" id="name" class="form-control" placeholder="Enter classification name" required>
        </div>
                    ...
                    <tbody>
                        @forelse($classifications as $classification)
                            <tr class="{{ $classification->trashed() ? 'table-secondary' : '' }}">
                                ...
                                <td>
                                    <div style="width: 30px; height: 20px; background-color: {{ $classification->color ?? '#fff' }}"></div>
                                </td>
                                <td>
                        ...
                        @empty
                            <tr><td colspan="5">No classifications found.</td></tr>
                        @endforelse
                        </tbody>
    </div>
